...
For a more detailed step-by-step process, please see [this notebook](https://nbviewer.jupyter.org/github/jocelynho/ga_capstone/blob/master/1_data_collection/1a_yellow_card.ipynb).
...
For a more detailed step-by-step process, please see [this notebook](https://nbviewer.jupyter.org/github/jocelynho/ga_capstone/blob/master/1_data_collection/1b_drugbank.ipynb).
...
For a more detailed step-by-step process, please see [this notebook](https://nbviewer.jupyter.org/github/jocelynho/ga_capstone/ga_capstone/blob/master/1_data_collection/1c_reviews.ipynb).
